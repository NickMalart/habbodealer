...
import threading
from dice_tracker import DiceSniffer
...
class DiceApp:
    def __init__(self):
        ...
        self.root.attributes("-topmost", True) # Keep on top of Origins
        ...
        self.log_box = tk.Listbox(self.root, width=40, height=10)
    ...
    def handle_new_die(self, al_string):
        """This runs every time an AL packet is found"""
